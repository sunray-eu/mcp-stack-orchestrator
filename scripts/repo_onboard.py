...
def generate_markdown(
    ...
    return (
        ...
        f"1. If MCP stack orchestrator tooling is available, run from stack root: "
        f"`task infra:status` and `task quality:doctor PROFILE=core`; otherwise skip this step.\n"
